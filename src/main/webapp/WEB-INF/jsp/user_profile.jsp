    ...
    <div class="row">
        ...
        <div class="col-md-3 mb-4">
            <div class="list-group">
                ...
                <a href="user/updateProfile" class="list-group-item list-group-item-action active">
                    <i class="fa fa-fw fa-user-edit mr-2"></i>个人资料
                </a>
                <a href="user/changePassword" class="list-group-item list-group-item-action">
            ...
            <div class="card card-body">
                ...
                <form action="user/updateProfile" method="post">
                    ...
                    <div class="form-group row">
                        <label class="col-md-3 col-form-label text-right" for="realname">头像</label>
                        <div class="col-md-9 col-lg-6">
                            <img id="userPictureImg" src="../../img/avatar/${currentUser.picture}.png"/>
                            <span class="text-secondary">（点击更换）</span>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        <label class="col-md-3 col-form-label text-right" for="email">E-mail</label>
                        <div class="col-md-9 col-lg-6">
